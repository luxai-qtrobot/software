...
SCRIPT_NAME="start_qt_respeaker_app"
...
rosparam load /home/qtrobot/catkin_ws/src/qt_respeaker_app/config/qt_respeaker_app.yaml

read -d '' SPEECHENV << EOF
export PYTHONPATH="${PYTHONPATH}:/home/qtrobot/catkin_ws/devel/lib/python3/dist-packages";
python3 /home/qtrobot/catkin_ws/src/qt_respeaker_app/src/qt_respeaker_app_node.py;
EOF
