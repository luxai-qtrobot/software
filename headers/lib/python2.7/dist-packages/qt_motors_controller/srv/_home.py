...
"""autogenerated by genpy from qt_motors_controller/homeRequest.msg. Do not edit."""
import sys
...
class homeRequest(genpy.Message):
  ...
  _type = "qt_motors_controller/homeRequest"
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from qt_motors_controller/homeResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class homeResponse(genpy.Message):
  ...
  _type = "qt_motors_controller/homeResponse"
  _has_header = False #flag to mark the presence of a Header object
...
def _get_struct_B():
    ...
    return _struct_B
class home(object):
  _type          = 'qt_motors_controller/home'
  _md5sum = '018aa38faa01fecffa7a4eb6cad48ceb'
